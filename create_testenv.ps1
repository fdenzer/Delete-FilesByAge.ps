...
$file.LastWriteTime = (Get-Date).AddDays(-181)
...
$folder.LastWriteTime = (Get-Date).AddDays(-181)
...
$subfolder_file.LastWriteTime = (Get-Date).AddDays(-181)
...
$third_file.LastWriteTime = (Get-Date).AddDays(-181)
